                           ...
                           <tr>
                            ...
                            @foreach($cats as $cat)
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" data-toggle="modal" data-target="#e{{$cat->id}}"><i class="fas fa-edit"></i></a>
                                        <!-- Modal -->
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-edit"></i>Edit {{$cat->cat_name}}</h5>
                                        ...
                                        <a href="{{route('remove.category',['id'=>$cat->id])}}" class="text-danger"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                        </table>
