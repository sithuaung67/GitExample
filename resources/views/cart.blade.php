...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <table class="table table-dark table-hover" style="margin-top: 70px;">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route('decrease.cart',['id'=>$item['item']['id']])}}"><i class="fas fa-minus-square"></i> </a>
                            {{$item['qty']}}
                            <a href="{{route('increase.cart',['id'=>$item['item']['id']])}}"><i class="fas fa-plus-square"></i> </a>
                        </td>
                        <td>
                            {{$item['amount']}} $</td>
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <a href="{{route('cancel.cart')}}" class="btn btn-outline-danger"> Cancel </a>
                            </td>
                        </tr>
                        @else
                        <tr>
