                    ...
                    <table class="table table-hover" id="dataTable">
                        ...
                        @foreach($pds as $pd)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('delete.product',['id'=>$pd->id])}}" class="btn btn-outline-danger btn-sm"><i class="fas fa-trash"></i></a>

                                    <a href="{{route('product.edit',['id'=>$pd->id])}}" class="btn btn-outline-primary btn-sm"><i class="fas fa-edit"></i></a>
